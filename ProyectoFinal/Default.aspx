...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="hero bg-violet-600 bg-gradient-to-r from-violet-900 h-full">
      <div class="hero-content text-center w-1/2 flex flex-col">
        <div class="grid grid-cols-2 items-center justify-items-center gap-7 mt-10">
            <div>
                <svg xmlns="http://www.w3.org/2000/svg" width="400px" height="100%" viewBox="0 0 1024 1024" fill="#000000" class="icon" version="1.1">
        ...
        <div class="mt-16 flex flex-row space-x-4 items-center">
            <p class="prose prose-xs !text-white">Oficios m&aacute;s solicitados</p>

            <ul class="flex flex-row space-x-6" runat="server">
                <asp:Repeater ID="RepeaterGruposTrabajosPorOficio" runat="server">
                    <ItemTemplate>
                        <li>
                            <a class="btn" href="Search.aspx?term=<%# Container.DataItem.Grupo %>">
